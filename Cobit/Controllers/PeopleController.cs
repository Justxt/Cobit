...
namespace Cobit.Controllers
{
    public class PeopleController : Controller
    {
        ...
        public PeopleController(CobitContext context, IConfiguration configuration)
        {
            _context = context;
        ...
        public async Task<IActionResult> Login([FromBody] LoginDto loginDto)
        {
            ...
            var role = person.Role; // Obtenemos el role

            return Ok(new { token, role }); // devolvemos el token y el rol
        }
